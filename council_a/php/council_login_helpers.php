...
if ($helper_type == "login") {
    ...
    // Note this routine is stored in the council's local php folder because this (or something like it)
    // is the only way to get the server root directory for the council and to set it logged_in session
