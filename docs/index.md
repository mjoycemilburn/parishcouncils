...
<p>Configuration and maintenance of a parishcouncil website is carried out via the ssytem's manager.html file. This is accessed by typing its url -  newbigginparishcouncil.com/manager.html in this case - into the browser search field. You might find it useful to create a bookmark for this.
</p>
